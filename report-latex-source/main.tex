...
\begin{enumerate}
    \item Se introduce una formulación binaria del Algoritmo de Optimización de la Morsa (***Binary Walrus Optimizer***, BWO)~\cite{han2023walrus} para resolver las restricciones de ubicación y asignación del TMLPA.
...
\midrule
\textbf{Pequeña} & Óptimo Global HiGHS  & \textbf{84,2000} & -- & -- & -- & -- & -- & -- \\
(3 Puntos / 5 Clientes) & BPSO & 84,2000 & 84,2000 & 84,2000 & 0,0000 & 1,0000 & 1,0100 & 0 \\
& BWO & 84,2000 & 84,2000 & 84,2000 & 0,0000 & 1,0000 & 1,0100 & 0 \\
\midrule
\textbf{Mediana} & Óptimo Global HiGHS  & \textbf{452,0000} & -- & -- & -- & -- & -- & -- \\
(10 Puntos / 25 Clientes) & BPSO & 461,0000 & 461,0000 & 461,0000 & 0,0000 & 0,0000 & 0,0000 & 0 \\
& BWO & 464,8000 & 473,5000 & 468,9767 & 2,5127 & 0,0000 & 0,0000 & 2 \\
\midrule
\textbf{Grande} & Óptimo Global HiGHS  & \textbf{915,2000} & -- & -- & -- & -- & -- & -- \\
(20 Puntos / 50 Clientes) & BPSO & 920,3000 & 946,9000 & 930,6000 & 7,8947 & 0,0000 & 0,0000 & 0 \\
& BWO & 933.1000 & 1076.4000 & 1006.1533 & 34.2454 & 0.0000 & 0.0000 & 0 \\
\bottomrule
\end{tabular}

\begin{tablenotes}\footnotesize
    \item[1] \textbf{$\mu$}: Promedio aritmético de los valores de la función objetivo calculado sobre exactamente $N=30$ ejecuciones independientes.
    \item[2] \textbf{$\sigma$}: Desviación estándar muestral; mide la dispersión del enjambre frente al nivel de explotación de soluciones.
    \item[3] \textbf{SRate} (\textit{Success Rate}): Tasa de éxito. Proporción de ejecuciones independientes que alcanzaron de manera exacta el óptimo global.
    \item[4] \textbf{SSpeed} (\textit{Search Speed}): Velocidad de búsqueda; métrica correspondiente al tiempo de convergencia generacional normalizado.
    \item[5] \textbf{Outliers}: Cantidad de ejecuciones anómalas detectadas por el filtro estadístico IQR y reemplazadas dinámicamente en caliente.
\end{tablenotes}
\end{threeparttable}
\end{table*}
...
Sin embargo, esta alta varianza exploratoria se transforma en una desventaja operativa cuando se dispone de presupuestos iterativos restringidos dentro de espacios de alta dimensionalidad. En la escala grande, BWO dispersó su esfuerzo de búsqueda en múltiples frentes conceptuales, lo que resultó en un número insuficiente de generaciones disponibles para explotar a fondo las regiones de interés localizadas. Esta menor tasa de convergencia local se tradujo en una mayor dispersión final ($\sigma = 34,2454$) y en una Brecha de Optimización superior ($+1,96\%$). Estos hallazgos sugieren que el rendimiento de BWO podría optimizarse sustancialmente mediante la inclusión de una función de transferencia adaptativa o un mecanismo de enfriamiento acelerado, orientados a potenciar sus capacidades de explotación a medida que el algoritmo avanza hacia sus etapas generacionales tardías.
