...
\begin{enumerate}
    \item Se introduce una formulación binaria del Algoritmo de Optimización de la Morsa (***Binary Walrus Optimizer***, BWO)~\cite{han2023walrus} para resolver las restricciones de localización y asignación peatonal del TMLPA.
